...
namespace cLibrary.WinCustomControl
{
    public class cButton : System.Windows.Forms.Button
    {
        ...
        private cBtnState btnState = cBtnState.Normal;
        ...
        private void paint_Background(PaintEventArgs e)
        {
            ...
            if (btnState == cBtnState.Inactive)
        ...
        private void paint_Text(PaintEventArgs e)
        {
            ...
            //
            if ((btnState == cBtnState.Pushed) && (OffsetPressedContent))
                rect.Offset(1, 1);
            //
        ...
        private void paint_Image(PaintEventArgs e)
        {
            ...
            if (image != null)
            {
                ...
                if ((btnState == cBtnState.Pushed) && (_OffsetPressedContent))
                    rect.Offset(1, 1);
        ...
        private System.Drawing.Image GetCurrentImage(cBtnState btnState)
        {
            ...
            switch (btnState)
            {
                ...
                case cBtnState.Inactive:
                    ...
                    else
                    {
                        if (this.ImageFocused != null)
                        {
                            ImageInactive = ConvertToGrayscale(new Bitmap(/*ImageNormal*/this.ImageFocused));
                        }
                        image = ImageInactive;// ImageNormal
                    }
                    break;
            }
            return (image);
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            else
            {
                //if(!this.Focused)
                {
                    if (btnState != cBtnState.MouseOver)
                    {
                        btnState = cBtnState.MouseOver;
                        this.Invalidate();
                    }
                }
            }
        ...
        protected override void OnEnabledChanged(EventArgs e)
        {
            ...
            if (this.Enabled)
            {
                this.btnState = cBtnState.Normal;
            }
            else
            {
                this.btnState = cBtnState.Inactive;
            }
            this.Invalidate();
        }
        /// <summary>
