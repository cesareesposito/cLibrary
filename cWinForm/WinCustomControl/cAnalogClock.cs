...
namespace cLibrary.WinCustomControl
{
    ...
    /// </summary>
    public class cAnalogClock : System.Windows.Forms.UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            // AnalogClock
            // 
            this.Name = "cAnalogClock";
            this.Resize += new System.EventHandler(this.cAnalogClock_Resize);
            this.Load += new System.EventHandler(this.cAnalogClock_Load);
            this.Paint += new System.Windows.Forms.PaintEventHandler(this.cAnalogClock_Paint);

        }
        #endregion

        private void cAnalogClock_Load(object sender, System.EventArgs e)
        {
            dateTime = isUTC ? DateTime.UtcNow : DateTime.Now;
            this.cAnalogClock_Resize(sender, e);
        }

        private void timer1_Tick(object sender, System.EventArgs e)
        {
            this.dateTime = isUTC ? DateTime.UtcNow : DateTime.Now;
            this.Refresh();
        }
        ...
        private void cAnalogClock_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
        {
        ...
        private void cAnalogClock_Resize(object sender, System.EventArgs e)
        {
        ...
        public bool IsUTC { get { return isUTC; } set { isUTC = value; } }
